...
class MovieRegisterViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if movie != nil {
            ...
            //eh armazenado como NSObjet, nao como 64
...
extension MovieRegisterViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingImage image: UIImage, editingInfo: [String: AnyObject]?) {
        ...
        //desenhando a imagem dentro desse contexto redimencionando
        image.draw(in: CGRect(x: 0, y: 0, width: smallSize.width, height: smallSize.height))
        
        //pego do contexto e tenho essa versao reduzida de la
        smallImage = UIGraphicsGetImageFromCurrentImageContext()
        
        ivPoster.image = smallImage
        
        //fechando esse contexto
